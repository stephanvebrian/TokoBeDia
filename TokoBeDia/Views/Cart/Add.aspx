<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="TokoBeDia.Views.Cart.Add" %>
		    ...
		    <div class="row justify-content-center mt-5">
                <div>
                    ...
                    <div class="form-group">
                      ...
                      <asp:Button ID="btnAdd" CssClass="btn btn-primary" runat="server" Text="Add Cart" OnClick="btnAdd_Click" />
                    <br />
                </div>
