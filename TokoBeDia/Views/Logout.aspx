<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Logout.aspx.cs" Inherits="TokoBeDia.Views.Logout" %>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown" id="usersNavbar" runat="server">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                            ...
                            <%--<a class="dropdown-item" href="~/Views/User/Add.aspx" id="user_insert" runat="server">Insert User</a>--%>
