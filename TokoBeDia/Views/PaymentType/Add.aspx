<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="TokoBeDia.Views.PaymentType.Add" %>
    ...
    <div class="home" style="min-height: 600px">
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div><h4>PaymentType/Add.aspx</h4></div>
		    </div>
	    </div>
        <div class="container">
            <div class="row justify-content-center">
                <div>
                    <h4 style="color: #532e43;">Add Payment Type</h4>
                    
                      <div class="form-group">
                        <label for="email">Type*</label>
                        <asp:TextBox ID="inputType" CssClass="form-control" runat="server" TextMode="SingleLine"></asp:TextBox>
                        <small id="typeHelp" class="form-text text-muted">Filled, unique, consist 3 or more character</small>
                      </div>
                      <asp:Label ID="formHelp" CssClass="form-text text-muted" runat="server" Text="Error" Visible="false"></asp:Label>
                      <asp:Button ID="btnAdd" CssClass="btn btn-primary" runat="server" Text="Add Payment Type" OnClick="btnAdd_Click" />
                    <br />
                </div>
            </div>
        </div>
