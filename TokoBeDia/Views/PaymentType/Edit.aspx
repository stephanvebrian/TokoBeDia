<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="TokoBeDia.Views.PaymentType.Edit" %>
                ...
                <div>
                    <h4 style="color: #532e43;">Edit Product Type</h4>
                      ...
                      <div class="form-group">
                        ...
                        <asp:TextBox ID="inputType" CssClass="form-control" runat="server" TextMode="SingleLine"></asp:TextBox>
