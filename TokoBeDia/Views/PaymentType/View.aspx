<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="TokoBeDia.Views.PaymentType.View" %>
    ...
    <div class="home" style="min-height: 600px">
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div><h4>PaymentType/View.aspx</h4></div>
		    </div>
	    </div>
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div>
                    <asp:GridView ID="gv_ViewPaymentType" AutoGenerateColumns="false" UseAccessibleHeader="true" 
                        DataKeyNames="Id"
