<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="TokoBeDia.Views.Product.Add" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="home" style="min-height: 650px; height: 100%">
	    ...
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div>
                    <h4 style="color: #532e43;">Add Product</h4>
                      ...
                      <div class="form-group">
                        ...
                        <small id="stockHelp" class="form-text text-muted">Input must be 1 or more</small>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <small id="priceHelp" class="form-text text-muted">Must be above 1000 and multiply of 1000</small>
                      </div>                      
