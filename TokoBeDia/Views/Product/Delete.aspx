<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="TokoBeDia.Views.Product.Delete" %>
    ...
    <div class="home" style="height: 100%; min-height: 650px;">
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div><h4>Product/Delete.aspx</h4></div>
		    </div>
	    </div>
    </div>
</asp:Content>
