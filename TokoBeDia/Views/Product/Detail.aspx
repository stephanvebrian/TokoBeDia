<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="TokoBeDia.Views.Product.Detail" %>
                    ...
                    <h4 style="color: #532e43;">View Product</h4>
                     <div class="form-group">
                        <label for="id">ID</label>
                         <asp:Label ID="lblId" CssClass="h4" runat="server" Text="ID01"></asp:Label>
                      </div>
                      <div class="form-group">
                        <label for="email">Name</label>
                        <asp:Label ID="lblName" CssClass="h4" runat="server" Text="Product"></asp:Label>
                      </div>
                      <div class="form-group">
                        <label for="stock">Stock</label>
                        <asp:Label ID="lblStock" CssClass="h4" runat="server" Text="1000"></asp:Label>
                      </div>
                      <div class="form-group">
                          <label for="Product Type">Product Type</label>
                          <asp:Label ID="lblType" CssClass="h4" runat="server" Text="Fashion"></asp:Label>
                      </div>
                      <div class="form-group">
                        <label for="price">Price</label>
                        <asp:Label ID="lblPrice" CssClass="h4" runat="server" Text="2000000"></asp:Label>
                      </div>                      
