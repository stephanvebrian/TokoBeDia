<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="TokoBeDia.Views.ProductType.Add" %>
    ...
    <div class="home" style="min-height: 600px">
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div><h4>ProductType/Add.aspx</h4></div>
		    </div>
	    </div>
        <div class="container">
            <div class="row justify-content-center">
                <div>
                    <h4 style="color: #532e43;">Add Product Type</h4>
