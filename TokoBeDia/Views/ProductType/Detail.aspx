<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="TokoBeDia.Views.ProductType.Detail" %>
    ...
    <div class="home" style="min-height: 600px">
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div><h4>ProductType/Detail.aspx</h4></div>
		    </div>
	    </div>
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div>
                    <h4 style="color: #532e43;">View Detail Product Type</h4>
                      ...
                      <%--<asp:Button ID="btnAdd" CssClass="btn btn-primary" runat="server" Text="Add Product Type" OnClick="btnAdd_Click" />--%>
                    <br />
                </div>
		    </div>
	    </div>
