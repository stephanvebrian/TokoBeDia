<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="TokoBeDia.Views.ProductType.Edit" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="home" style="min-height: 800px">
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div><h4>ProductType/Edit.aspx</h4></div>
		    </div>
	    </div>
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div>
                    <h4 style="color: #532e43;">Edit Product Type</h4>
                      ...
                      <div class="form-group">
                        ...
                        <asp:TextBox ID="inputDescription" CssClass="form-control" runat="server" TextMode="MultiLine" Height="150px"></asp:TextBox>
                      ...
                      <asp:Button ID="btnEdit" CssClass="btn btn-primary" runat="server" Text="Edit Product Type" OnClick="btnEdit_Click" />
                    <br />
                </div>
		    </div>
	    </div>
