<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="TokoBeDia.Views.Profile.Edit" %>
    ...
    <div class="home" style="height: 100%">
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div><h4>Profile/Edit.aspx</h4></div>
		    </div>
	    </div>
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div>
                    <h4 style="color: #532e43;">Edit Profile</h4>
                      <div class="form-group">
                        <label for="id">ID</label>
                        <asp:TextBox ID="inputId" CssClass="form-control" runat="server" TextMode="SingleLine"></asp:TextBox>
                      </div>
                      <div class="form-group">
                        <label for="role">Role</label>
                        <asp:TextBox ID="inputRole" CssClass="form-control" runat="server" TextMode="SingleLine"></asp:TextBox>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <%--<small id="descriptionHelp" class="form-text text-muted">Must be filled.</small>--%>
                      </div>
                      <div class="form-group">
                        <label for="status">Status</label>
                        <asp:TextBox ID="inputStatus" CssClass="form-control" runat="server" TextMode="SingleLine"></asp:TextBox>
                        <%--<small id="descriptionHelp" class="form-text text-muted">Must be filled.</small>--%>
                      </div>
                      <asp:Label ID="formHelp" CssClass="form-text text-muted" runat="server" Text="Error" Visible="false"></asp:Label>
                      <asp:Button ID="btnEdit" CssClass="btn btn-primary" runat="server" Text="Update Profile" OnClick="btnEdit_Click" />
                    <br />
                </div>
		    </div>
    </div>
