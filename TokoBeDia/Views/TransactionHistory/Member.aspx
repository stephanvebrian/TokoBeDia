<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="Member.aspx.cs" Inherits="TokoBeDia.Views.TransactionHistory.Member" %>
...
<%--                    <asp:GridView ID="gv_AdminTransactionHistory" AutoGenerateColumns="false" UseAccessibleHeader="true" 
                    ...
                    <asp:GridView 
                        ID="gv_MemberTransactionHistory" 
                        CellPadding="3"
                        runat="server"
                        CssClass="table table-condensed table-hover"
                        OnPreRender="gv_MemberTransactionHistory_PreRender"
                        >
