<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="TokoBeDia.Views.User.View" %>
    ...
    <div class="home" style="min-height: 600px">
	    <div class="container">
		    <div class="row justify-content-center mt-5">
                <div><h4>User/View.aspx</h4></div>
		    </div>
	    </div>
        <div class="container" runat="server">
		    <div class="row justify-content-center mt-5">
                <div>
                    <asp:GridView ID="gv_ViewUser" AutoGenerateColumns="false" UseAccessibleHeader="true" 
                        DataKeyNames="Id"
                        ...
                        <Columns>  
                            ...
                            <asp:BoundField DataField="Status.Name" HeaderText="Status Name" />
